...
\left\langle a^{(1)} \mid \alpha\right\rangle\left\langle a^{(1)} \mid \beta\right\rangle^* & \left\langle a^{(1)} \mid \alpha\right\rangle\left\langle a^{(2)} \mid \beta\right\rangle^* & \ldots \\
\left\langle a^{(2)} \mid \alpha\right\rangle\left\langle a^{(1)} \mid \beta\right\rangle^* & \left\langle a^{(2)} \mid \alpha\right\rangle\left\langle a^{(2)} \mid \beta\right\rangle^* & \ldots \\
\vdots & \vdots & \ddots
\end{array}\right) .
$$
...
Let $\ket{\alpha} = S_{z}\ket{+} = \begin{bmatrix} 1 \\ 0 \end{bmatrix}$ . We also know $\ket{\beta} = |S_{x}\ket{+}$ so 
